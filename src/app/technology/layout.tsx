...
export const metadata: Metadata = {
  ...
  description:
    'Built on Next.js 16, React 19, Node.js, PostgreSQL, Redis, Socket.IO, and AWS. 88 REST endpoints, 85+ WebSocket events, 3,000+ automated tests across three tiers.',
  openGraph: {
    type: 'website',
    title: 'Technology — Architecture & Stack',
    description:
